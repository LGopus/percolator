...
```text
SUMMARY: 19 passed, 0 failed/timeout (0 timeout) out of 19
```
...
| Fail | 0 |
| Timeout | 0 |
| Total wall-clock harness time | 397s |
...
| `proof_v13_attach_then_clear_leg_restores_account_local_counters_for_long` | 45s | PASS |
| `proof_v13_b_residual_booking_makes_durable_progress_or_fails_closed` | 37s | PASS |
...
| `proof_v13_equity_active_accrual_requires_protective_progress` | 8s | PASS |
...
| File | Harnesses |
|---|---:|
| `tests/proofs_v13.rs` | 19 |

Strength indicators:

| Check | Result |
|---|---:|
| Harnesses over v13 production code | 19 |
...
The Rust suite currently covers 50 wide-math unit tests and 28 v13 spec tests.
...
risk-reducing trade liveness, and permissionless account-local progress. The
