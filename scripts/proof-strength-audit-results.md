...
| `proof_v15_public_invariants_reject_hard_global_bounds` | 8.5s | PASS |
...
| `proof_v15_health_certificate_bound_to_market_epochs_and_prices` | 52s | PASS |
...
| `proof_v15_public_invariants_reject_hard_global_bounds` | 5s | PASS |
| `proof_v15_pending_domain_barrier_blocks_trade_weight_escape_before_mutation` | 83.9s | PASS |
| `proof_v15_pending_domain_barrier_blocks_rebalance_weight_escape_before_mutation` | 40.3s | PASS |
...
| `certificate_bound_to_market_config_asset_slots_and_prices` | `v15_health_certificate_is_bound_to_market_epochs_and_prices`; `proof_v15_health_certificate_bound_to_market_epochs_and_prices`; favorable-action stale certificate rejection tests/proofs |
...
| `pending_domain_loss_barrier_blocks_weight_exit_until_residual_durable` | `v15_pending_domain_loss_barrier_blocks_other_participants_until_residual_done`; `v15_pending_domain_loss_barrier_blocks_trade_weight_escape_before_fee_or_position_mutation`; `v15_pending_domain_loss_barrier_blocks_rebalance_weight_escape_before_position_mutation`; `v15_pending_domain_loss_barrier_blocks_side_reset_before_residual_done`; `v15_pending_domain_loss_barrier_does_not_freeze_unrelated_positive_credit`; `proof_v15_pending_domain_barrier_blocks_participants_until_residual_finalized`; `proof_v15_pending_domain_barrier_blocks_trade_weight_escape_before_mutation`; `proof_v15_pending_domain_barrier_blocks_rebalance_weight_escape_before_mutation`; `proof_v15_pending_domain_barrier_blocks_side_reset_before_mutation`; `proof_v15_pending_domain_barrier_does_not_freeze_unrelated_positive_credit` |
...
No missing engine-side v15 spec §15 coverage item was identified. No confirmed
...
against the current 161-proof inventory and replace the older 57-proof timing
artifacts.
